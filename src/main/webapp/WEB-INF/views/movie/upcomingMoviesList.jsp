<%--
    파일명: upcomingMoviesList.jsp
    설명: 이 JSP 파일은 '모든 개봉 예정작' 목록을 표시하는 페이지입니다.
          `movieController`의 특정 메서드로부터 `upcomingMovies` 리스트를 받아와
...
/* 개봉 예정작 배지 스타일 (D-Day) */
.movie-card .release-badge { /* ⭐ .rank-badge 대신 .release-badge 사용 ⭐ */
    position: absolute;
    top: 10px;
    left: 10px;
    background-color: rgba(0, 0, 0, 0.7); /* ⭐ 이 색상 값을 변경했습니다. ⭐ */
    color: white;
    font-size: 1.1em;
    font-weight: bold;
    padding: 5px 8px;
...
<body>
    ...
    <main class="container py-4">
        <h2 class="section-title">모든 개봉 예정작</h2>
        ...
        <c:choose>
                    ...
                    <c:forEach var="movie" items="${upcomingMovies}">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="movie-card">
                                <div class="release-badge">D-${movie.dday}</div>
                                <a href="<c:url value='/movies/${movie.id}'/>">
                                    ...
                                    <div class="p-3">
                                        ...
                                        <p class="text-muted mb-1">
                                            ...
                                            <c:if test="${movie.genre != null and movie.genre ne ''}"> | ${movie.genre}</c:if>
                                        </p>
                                        <p class="text-muted mb-0">D-day: ${movie.dday}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
            ...
            <c:otherwise>
                <p class="no-movies-message">등록된 개봉 예정작이 없습니다.</p>
            </c:otherwise>
        </c:choose>
    </main>

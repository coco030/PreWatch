<%--
    ...
    개선 사항:
        - Bootstrap Grid System을 적용하여 반응형 웹 디자인을 구현했습니다.
          (PC: 4열, 태블릿: 3열, 모바일 가로: 2열, 모바일 세로: 1열)
        - 카드 간의 간격(gutter)을 일관성 있게 조정하고, 카드 높이를 통일하여 레이아웃을 안정시켰습니다.
        - 찜한 영화가 없을 때 표시되는 메시지와 링크를 시각적으로 개선하여 사용자 경험을 향상시켰습니다.
--%>
...
<body>
    ...
    <main class="container my-5">
        <h2 class="section-title mb-4">나의 찜 영화 목록</h2>
        ...
        <c:choose>
                    ...
                    <c:forEach var="movie" items="${likedMovies}">
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="movie-card h-100">
                                ...
                                <a href="<c:url value='/movies/${movie.id}'/>" class="text-decoration-none text-dark">
                                    <c:set var="posterSrc">
                                        <c:choose>
                                    ...
                                    <img src="${posterSrc}" alt="${movie.title} 포스터" class="card-img-top"/> 
                                    <div class="card-body"> 
	                                    <h3>${movie.title}</h3>
            ...
            <c:otherwise>
                <%-- ⭐ 찜한 영화가 없을 경우 표시되는 메시지 --%>
                <div class="text-center p-5 my-5 bg-light rounded">
                    <p class="lead mb-4">아직 찜한 영화가 없습니다.</p>
                    <p>마음에 드는 영화를 발견하면 하트 아이콘을 눌러 찜 목록에 추가해보세요!</p>
                    <a href="<c:url value='/'/>" class="btn btn-primary mt-3">홈으로 가서 영화 둘러보기</a>
                </div>
            </c:otherwise>
        </c:choose>
    </main>
